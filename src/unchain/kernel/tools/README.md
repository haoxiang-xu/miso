...
- `confirmation.py`: confirmation gate helpers
- `observation.py`: observation prompt/constants/helpers
- `human_input.py`: human-input helpers and resume harness
- `execution.py`: tool execution harness

...
## [Interaction API Reference](../api/interaction.md)
...
- `ExecutionCheckpointError` and typed subclasses -> `src/unchain/memory/checkpoint_state.py` (subpackage, classes)
...
- `SessionRevisionConflictError` and `SessionStoreCorruptionError` -> `src/unchain/memory/revision.py` (subpackage, classes)

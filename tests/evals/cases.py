    ...
    return [
        build_eval_case(
            ...
            rule_checks={
                ...
                "required_tool_any_of": [["list_directory", "search_text", "read_file"]],
                "min_tool_calls": 3,
                "min_final_chars": 180,
        ...
        build_eval_case(
            ...
            rule_checks={
                ...
                "required_tool_any_of": [["read_file", "read_lines", "search_text"]],
                "min_tool_calls": 2,
                "min_final_chars": 140,
        ...
        build_eval_case(
            ...
            rule_checks={
                ...
                "required_tool_any_of": [["read_file", "read_lines", "search_text", "list_directory"]],
                "min_tool_calls": 2,
                "min_final_chars": 160,

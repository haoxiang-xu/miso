...
* **streamable_http** – connects to a Streamable HTTP endpoint  
  ``mcp(url="http://localhost:8080/mcp", transport="streamable_http")``
...
from .tool import tool, tool_parameter, toolkit
...
class mcp(toolkit):
    ...
    def _convert_mcp_tool(self, mcp_tool) -> tool:
        ...
        parameters: list[tool_parameter] = []
    ...
    def __repr__(self) -> str:
        ...
        return f"mcp({target}, {status}, {n_tools} tools)"
